...
// Python like indentation, taken from https://github.com/antlr/grammars-v4/blob/master/python3/Python3.g4
// and http://stackoverflow.com/questions/8642154/antlr-what-is-simpliest-way-to-realize-python-like-indent-depending-grammar
...
@lexer::members {
  ...
  public Token nextToken() {
    ...
    if (_input.LA(1) == EOF && !this.indents.isEmpty()) {
      ...
      this.emit(commonToken(SpellParser.NEWLINE, "\n"));
      ...
      this.emit(commonToken(SpellParser.EOF, "<EOF>"));
    }
  ...
  private Token createDedent() {
    CommonToken dedent = commonToken(SpellParser.DEDENT, "");
   ...
   )
   {
     ...
     if (opened > 0 || next == '\r' || next == '\n' || next == '#') {
       ...
       if (indent == previous) {
         ...
         indents.push(indent);
         emit(commonToken(SpellParser.INDENT, spaces));
       }
       else {
